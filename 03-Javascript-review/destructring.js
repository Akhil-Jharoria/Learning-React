...
//   console.log(title,author,translations);
// console.log(translations);

//destructuring of object
// const {title,translations,pages,genres,mylove}=book;
// console.log(title,translations,pages,title,genres,mylove);

// const arr=genres;
// console.log(arr);

// const firstgenres=arr[0];
// const secondgenres=arr[1];
// const thirdgenres=arr[2];
// console.log(firstgenres,secondgenres,thirdgenres);
